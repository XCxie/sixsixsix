...
#define SDI_H			GPIO_SetBits(GPIOB,GPIO_Pin_5)      //串行通信数据输入
#define RST_H			GPIO_SetBits(GPIOC,GPIO_Pin_3)     //复位
#define CLK_H			GPIO_SetBits(GPIOB,GPIO_Pin_3)   //串行通信时钟输入
#define CS_H			GPIO_SetBits(GPIOD,GPIO_Pin_2)   //片选
#define SDI_L			GPIO_ResetBits(GPIOB,GPIO_Pin_5)
#define RST_L			GPIO_ResetBits(GPIOC,GPIO_Pin_3)  //>400ns
#define CLK_L			GPIO_ResetBits(GPIOB,GPIO_Pin_3)
#define CS_L			GPIO_ResetBits(GPIOD,GPIO_Pin_2)
#define READ_SDO		GPIO_ReadInputDataBit(GPIOB,GPIO_Pin_4)
